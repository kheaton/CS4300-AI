function [mean, var, success, confidence] = CS4300_A1_Part_II_2_runner(num_of_trials)
...
%   confidence  (Float): The 95% confidence interval for the mean
% Call:
...
% get confidence
confidence = 1.645 * sqrt(var) / sqrt(num_of_trials);
